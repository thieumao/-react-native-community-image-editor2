...
`yarn add react-native-community-image-editor2`

or

`npm install react-native-community-image-editor2 --save`
...
`react-native link react-native-community-image-editor2`
...
```javascript
import ImageEditor from "react-native-community-image-editor2";
```
